...
import server from '../server.js' // Import the server object
...
// Mantiene la referencia de las pets en todos los tests, es decir que este test también contiene el último pet guardado en el test de guardar
describe('DELETE "/:id"', () => {
